...
export function GoogleButton() {
  ...
  return (
    <a
      ...
      className="w-full rounded-xl border border-afya-border bg-white px-6 py-3.5 text-sm font-bold text-afya-charcoal hover:bg-afya-bg/60 transition-colors flex items-center justify-center gap-2.5"
    >
