...
const STORIES: Story[] = [
  ...
  },
  {
    ...
    insight_en: "Horizon-specialised models forecast exposure at +1h, +3h and +6h with calibrated uncertainty, and the Climate Reflex engine identifies the coming state transition.",
    insight_sw: "Mifumo maalum hutabiri kupatwa kwa +saa 1, +3 na +6 pamoja na utata uliorekebishwa, na Climate Reflex hutambua mabadiliko ya hali yanayokuja.",
