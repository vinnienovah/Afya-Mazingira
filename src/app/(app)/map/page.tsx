    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-2 text-[11px] font-semibold text-afya-muted">
          <Radio className="w-3.5 h-3.5 text-afya-green live-pulse" aria-hidden="true" />
          ...
          <Card padding={false} className="overflow-hidden">
            ...
            <div className="px-4 py-2.5 border-t border-afya-border flex flex-wrap gap-x-4 gap-y-1">
              <span className="text-[10px] text-afya-muted flex items-center gap-1">
                <span className="w-2.5 h-2.5 rounded-full bg-afya-green inline-block live-pulse" aria-hidden="true" />
  ...
  return (
    <Card>
      <div className="flex items-center gap-2 mb-3">
        <span className="w-3 h-3 rounded-full bg-afya-green live-pulse shrink-0" aria-hidden="true" />
        <div>
