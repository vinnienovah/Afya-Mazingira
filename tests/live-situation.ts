...
export function liveSituation(overrides: Partial<SituationResult> = {}): SituationResult {
  return {
    ...
    contributors: [
      ...
      { feature: "peak_radiation", direction: "high" },
    ],
    era5: {
    ...
    chirps: {
      available: true, chirps_mm: 0.1, chirps_7d_mm: 14.9, chirps_30d_mm: 24.1, chirps_percentile: 47,
      chirps_dry_spell_days: 0, chirps_wet_spell_days: 10, valid_date: "2026-09-17",
    },
    sentinel: {
...
export const LIVE_MAIZE_ADVISORY = {
  ...
  water_balance: {
    ...
    balance_7d_mm: -5.3, soil_moisture_pct: 18, depletion_pct: 100, readily_available_mm: 77,
  },
  irrigation: {
    action: "IRRIGATE_NOW", depth_mm: 65, litres_per_m2: 65, depth_range_mm: { low: 65, high: 110 },
    reason_keys: ["farm_reason_high_depletion", "farm_reason_demand_exceeds_rain", "farm_reason_low_soil_moisture"],
    confidence: "HIGH",
  },
  spray_window: { operation: "spraying", quality: "MARGINAL", reason_keys: ["farm_reason_wind_suitable", "farm_reason_rain_possible"] },
  planting: { favourable: false, rain_30d_mm: 24.1, required_mm: 40, dry_spell_days: 0, percentile: 47, message_key: "farm_plant_insufficient" },
  stress: { level: "NONE", peak_temp_c: 24.5, reason_keys: ["farm_reason_no_heat_stress"] },
